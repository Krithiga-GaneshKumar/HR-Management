...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "UPDATE vacation SET status='$status', days='$amount', remaining=remaining-$amount WHERE eid='$id'";
...
<div></div>
    <div class="form-container">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        ...
        <input type="date" id="name" name="t60" placeholder="To Date">

        <label for="from">From:</label>
        <input type="date" id="name" name="t61" placeholder="From Date">
