...
$cover=$row_user['profile'];

$join=strtotime($row_user['doj']);
$j=date('d F Y',$join);
?>
<body>
	<h1><?php echo  "Welcome ". $row_user['f_name'] ?></h1>
...
<tr>
			...
			<td class="right"><?php echo $row_user['door'] .",".$row_user['street'] .",".$row_user['area']. ",".$row_user['city'].",".$row_user['pincode'].",".$row_user['state'];?></td>
		</tr>
	</table>
